...
%     kc=
    ...
    dF(2) = - (0.01801528/(T_top * 8.3145) * p_water(T_top) - 0.017274) * A_top * h_top_outside(T_top, D_in) * (2.9e-6) * ((T_A + T_top)/2) / (rho_air((T_A + T_top)/2)^(1/3) * cp_air((T_A + T_top)/2)^(1/3) * k_air((T_A + T_top)/2)^(2/3));
